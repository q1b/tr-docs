...
function animation(uid,enter,enterFrom,enterTo,direction="alternate",hiddenFlag=false,easing) {
  return (
      `
...
---
<div class={clx} style={sty} id={uid} data-show={`${show}`} >
  <slot />
</div>
